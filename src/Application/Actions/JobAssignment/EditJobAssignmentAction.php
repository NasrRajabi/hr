...
class EditJobAssignmentAction extends Action
{
//LeaveRequestValidator
    ...
    protected function action(): Response
    {
                ...
                $id=($this->args["id"]);
        $data=JobAssignmentstoreModel::viow_job_assigment($id);
       //dd($data);
        return $this->view->render(
            $this->response,
            
            'job_assignment/edit.twig',['data'=>$data['result'],'vacation_status'=>$vacation_status,'job_assignment_type'=>$job_assignment_type,'country'=>$country,
