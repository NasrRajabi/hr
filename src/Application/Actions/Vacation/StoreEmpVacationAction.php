...
class StoreEmpVacationAction extends Action
{
    /**
     * {@inheritdoc}
     */
    protected function action(): Response
    {
        ...
        VacationModel::storeEmpVac([(int) $employee_id, (int) $data['vacation_type'], (int) $data['annual_vac_type'], $data['start_date'],
                       $data['end_date'], (string) $data['address'], (string) $data['mobile'], (string) $data['phone'], (string) $data['notes'], (int) $vac_sts, (int) $employee_id, date('Y-m-d H:i:s') ]);
