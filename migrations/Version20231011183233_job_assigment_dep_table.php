 ...
 */
final class Version20231011181135_job_assigment_dep_table extends AbstractMigration
{
    ...
    {
        $table = $schema->createTable('job_assigment_dep');
        ...
        $table->addColumn('emp_count', Types::INTEGER)->setNotnull(false)->setDefault(null);
    ...
    public function down(Schema $schema): void
    {
        ...
        $schema->dropTable('job_assigment_dep');
