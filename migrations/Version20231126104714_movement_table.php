 ...
 */
final class Version20231126104714 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $table->addColumn('end_movement_date', Types::DATE_MUTABLE)->setNotnull(false)->setDefault(null);
        $table->addColumn('driver', Types::INTEGER);
        $table->addColumn('starting_hour', Types::STRING);
        $table->addColumn('end_hour', Types::STRING)->setNotnull(false)->setDefault(null);
        $table->addColumn('star_counter_no', Types::STRING);
        $table->addColumn('end_counter_no', Types::STRING)->setNotnull(false)->setDefault(null);
        $table->addColumn('movement_status', Types::INTEGER);
